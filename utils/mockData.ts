...
export const mockGalleryImages: IGalleryImage[] = [
    {
        id: 1,
        userId: 'user1',
        filePath: 'https://picsum.photos/400/400?random=21',
        prompt: '우주를 나는 고래',
        artStyle: '디지털아트',
        colorTone: '밝은',
        tags: ['우주', '고래', '환상적'],
    ...
    },
    {
        id: 2,
        userId: 'user1',
        filePath: 'https://picsum.photos/400/400?random=22',
        prompt: '신비로운 숲속의 요정',
        artStyle: '수채화',
        colorTone: '파스텔',
        tags: ['요정', '숲', '마법'],
    ...
    },
    {
        id: 3,
        userId: 'user1',
        filePath: 'https://picsum.photos/400/400?random=23',
        prompt: '미래도시의 일상',
        artStyle: '디지털아트',
        colorTone: '네온',
        tags: ['미래', '도시', '사이버펑크'],
    ...
    },
    {
        id: 4,
        userId: 'user1',
        filePath: 'https://picsum.photos/400/400?random=24',
